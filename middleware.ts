 ...
 * This middleware refreshes the user's session and protects routes
 */
...
export async function middleware(request: NextRequest) {
  ...
  // Redirect to login if accessing protected route without authentication (skip public routes)
